...
public class SubCategoryProductsResponseProduct {
    @SerializedName("id")
    @Expose
    private String id;
    ...
    @SerializedName("rate")
    @Expose
    private List<SubCategoryProductsResponseProductRate> rate = null;
    ...
    public List<SubCategoryProductsResponseProductRate> getRate() {
        return rate;
    }

    public void setRate(List<SubCategoryProductsResponseProductRate> rate) {
        this.rate = rate;
    }
}
